...
enum FinancialDataFingerprint {
    static func hash(
        ...
        for transaction in transactions {
            ...
            hasher.combine(transaction.createdByUserId)
            hasher.combine(transaction.rowVersion)
            hasher.combine(transaction.lastMutationId)
        ...
        for settlement in settlements {
            ...
            hasher.combine(settlement.createdByUserId)
            hasher.combine(settlement.rowVersion)
            hasher.combine(settlement.lastMutationId)
